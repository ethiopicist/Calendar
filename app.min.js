...
var e=$(".calendar-title").children();for($(".calendar-title").text(printTitle()),$(".calendar-title").append(e),j=0;j<7;j++)$(".calendar-dow").append($("<th/>").text(printDayName((j+parseInt(getPref("startDay")))%7)));
// calendar cells
for(var t=firstOfCalendar(),a=1;t<=lastOfMonth();){for($("tbody").append('<tr id="calendar-row-'+a+'"></tr>'),j=0;j<7;j++){var r=$("<td/>");r.append($('<span class="edate"/>').text(printDayInt(eDate(t).day))),getPref("showgDates")&&r.append($('<span class="gdate"/>').text(t.getDate())),
// highlight today
...
(dayBefore(t).getMonth()!==t.getMonth()||1==a&&0==j)&&getPref("showgDates")&&r.append($('<span class="gmonth"/>').text(t.toLocaleString("en-us",{month:getPref("longNames")?"long":"short",year:"numeric"}))),$("#calendar-row-"+a).append(r),t.setDate(t.getDate()+1)}a++}
...
function getPref(e){
// the default prefs
var t={startDay:1,ethletters:!0,ethnumbers:!0,monthNames:"gez",dowNames:"gez",longNames:!0,showgDates:!0};
...
// validate val
var a={startDay:["1","0"],ethletters:"boolean",ethnumbers:"boolean",monthNames:["gez","amh","tig"],dowNames:["gez","amh","tig","eng"],longNames:"boolean",showgDates:"boolean"};if("startDay"==e){if(!a.hasOwnProperty(e))return!1;// not a valid pref
...
function firstOfCalendar(){var e=firstOfMonth(),t=firstOfMonth().getDay()-parseInt(getPref("startDay"));
// this is to check what dow the first of month is, then move backwards until reaching startDay
return 0==firstOfMonth().getDay()&&(t=6),e.setDate(e.getDate()-t),e}
...
////////////////////////////
function printMonthName(e){var t=["መስከረም","ጥቅምት","ኅዳር","ታኅሣሥ","ጥር","የካቲት","መጋቢት","ሚያዝያ","ግንቦት","ሰኔ","ሐምሌ","ነሐሴ","ጳጕሜን"],a=["Maskaram","Ṭəqəmt","Ḫədār","Tāḫśāś","Ṭərr","Yakkātit","Maggābit","Miyāzyā","Gənbot","Sane","Ḥamle","Naḥase","Ṗāgʷəmen"],r=t.slice();r[5]="ለካቲት",r[4]="ጥሪ",r[1]="ጥቅምቲ";var n=a.slice();n[5]="Lakkātit",n[4]="Ṭərri",n[1]="Ṭəqəmti";var o="";return o="tig"==getPref("monthNames")&&getPref("ethletters")?r[e-1]:"tig"==getPref("monthNames")?n[e-1]:getPref("ethletters")?t[e-1]:a[e-1],getPref("longNames")?o:o.substr(0,3)}function printDayName(e){var t=["እሑድ","ሰኑይ","ሠሉስ","ረቡዕ","ኀሙስ","ዐርብ","ቀዳም"],a=["ʾƎḥud","Sanuy","Śalus","Rabuʿ","Ḫamus","ʿArb","Qadām"],r=["እሑድ","ሰኞ","መክሰኞ","ረቡዕ","ኀሙስ","ዓርብ","ቅዳሜ"],n=["ʾƎḥud","Saño","Maksaño","Rabuʿ","Ḫamus","ʿĀrb","Qədāme"],o=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],i=["እሑድ","ሶኑይ","ሦሉስ","ሮቡዕ","ሓሙስ","ዓርቢ","ቐዳም"],s=["ʾƎḥud","Sonuy","Śolus","Robuʿ","Ḥāmus","ʿĀrbi","Q̱adām"],h="";return h="eng"==getPref("dowNames")?o[e]:"eng"==getPref("dowNames")?o[e]:"amh"==getPref("dowNames")&&getPref("ethletters")?r[e]:"amh"==getPref("dowNames")?n[e]:"tig"==getPref("dowNames")&&getPref("ethletters")?i[e]:"tig"==getPref("dowNames")?s[e]:getPref("ethletters")?t[e]:a[e],getPref("longNames")?h:4!=e||"amh"!=getPref("dowNames")||getPref("ethletters")?6!=e||"amh"!=getPref("dowNames")||getPref("ethletters")?h.substr(0,3):"ʾ"+h.substr(1,3):"ʿ"+h.substr(1,3)}function printDayInt(e){return getPref("ethnumbers")?ethiopicNumber(e):e}function printTitle(){var e=printMonthName(theDate("em"))+" ";return getPref("ethnumbers")?e+=ethiopicNumber(theDate("ey")):e+=theDate("ey"),e}function ethiopicNumber(e){return"number"!=typeof e&&(e=parseInt(e)),0==e?"":1==e?"፩":2==e?"፪":3==e?"፫":4==e?"፬":5==e?"፭":6==e?"፮":7==e?"፯":8==e?"፰":9==e?"፱":10<=e&&e<20?"፲"+ethiopicNumber(e-10):20<=e&&e<30?"፳"+ethiopicNumber(e-20):30<=e&&e<40?"፴"+ethiopicNumber(e-30):40<=e&&e<50?"፵"+ethiopicNumber(e-40):50<=e&&e<60?"፶"+ethiopicNumber(e-50):60<=e&&e<70?"፷"+ethiopicNumber(e-60):70<=e&&e<80?"፸"+ethiopicNumber(e-70):80<=e&&e<90?"፹"+ethiopicNumber(e-80):90<=e&&e<100?"፺"+ethiopicNumber(e-90):100<=e&&e<200?"፻"+ethiopicNumber(e-100):200<=e&&e<1e4?ethiopicNumber((e-e%100)/100)+"፻"+ethiopicNumber(e%100):1e4<=e&&e<2e4?"፼"+ethiopicNumber(e-1e4):2e4<=e&&e<1e6?ethiopicNumber((e-e%1e4)/1e4)+"፼"+ethiopicNumber(e%1e4):void 0}$(document).ready(function(){buildCalendar(),
// calendar onclick events
$(document).on("click","a[id^='today']",function(){var e=new Date;setTheDate(eDate(e).year,eDate(e).month,eDate(e).day)}),$(document).on("click","a[id^='prev-month']",function(){var e=firstOfMonth();e.setDate(e.getDate()-1),setTheDate(eDate(e).year,eDate(e).month,eDate(e).day)}),$(document).on("click","a[id^='next-month']",function(){var e=lastOfMonth();e.setDate(e.getDate()+1),setTheDate(eDate(e).year,eDate(e).month,eDate(e).day)});
// fill out prefs form
...
$(document).on("click","a[id^='open-preferences']",function(){$("#preferences-overlay").show()}),$(document).on("click","a#close-preferences",function(){$("#preferences-overlay").hide()}),$(document).on("change","select",function(){setPref($(this).attr("id"),$(this).val())}),$(document).on("change","input[type=checkbox]",function(){setPref($(this).attr("id"),$(this).is(":checked"))})});